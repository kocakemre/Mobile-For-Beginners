...
namespace FirstCore.Controllers
{
    public class CityController : Controller
    {
        ...
        {
            //Include fonksiyonu ile Tüm liste içerisinde dönmek yerine sadece ilgili veriyi tekrarsız olarak döner.
            var cities = _db.Set<City>().Include(x => x.Personnel).ToList();
            return View(cities);
        }

        public IActionResult RelatedList()
        {
            //Include fonksiyonu ile Tüm liste içerisinde dönmek yerine sadece ilgili veriyi tekrarsız olarak döner.
            var cities = _db.Set<City>().Include(x => x.Personnel).Select(x => x.Personnel).ToList();
            return View(cities);
        }
